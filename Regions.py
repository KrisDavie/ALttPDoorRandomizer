...
location_table = {'Mushroom': (0x180013, False, 'in the woods'),
                  ...
                  'Desert Palace - Prize': ([0x1209E, 0x53E78, 0x53E79, 0x180053, 0x180072, 0xC6FF], True, 'Desert Palace'),
                  'Tower of Hera - Prize': ([0x120A5, 0x53E7A, 0x53E7B, 0x18005A, 0x180071, 0xC706], True, 'Tower of Hera'),
                  'Palace of Darkness - Prize': ([0x120A1, 0x53E7C, 0x53E7D, 0x180056, 0x180073, 0xC702], True, 'Palace of Darkness'),
                  'Swamp Palace - Prize': ([0x120A0, 0x53E7E, 0x53E7F, 0x180055, 0x180079, 0xC701], True, 'Swamp Palace'),
                  'Thieves\' Town - Prize': ([0x120A6, 0x53E80, 0x53E81, 0x18005B, 0x180076, 0xC707], True, 'Thieves\' Town'),
                  'Skull Woods - Prize': ([0x120A3, 0x53E82, 0x53E83, 0x180058, 0x180074, 0xC704], True, 'Skull Woods'),
                  'Ice Palace - Prize': ([0x120A4, 0x53E84, 0x53E85, 0x180059, 0x180078, 0xC705], True, 'Ice Palace'),
                  'Misery Mire - Prize': ([0x120A2, 0x53E86, 0x53E87, 0x180057, 0x180077, 0xC703], True, 'Misery Mire'),
                  'Turtle Rock - Prize': ([0x120A7, 0x53E88, 0x53E89, 0x18005C, 0x180075, 0xC708], True, 'Turtle Rock')}
