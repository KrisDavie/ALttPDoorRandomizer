...
from tkinter import ttk, Frame, N, E, W, NW, LEFT, X, VERTICAL, Y, Canvas, Button, FIRST, LAST, BOTH
from turtle import color
from PIL import ImageTk, Image
import source.gui.widgets as widgets
import source.gui.customizer.location_data as location_data
from source.overworld.EntranceShuffle2 import entrance_map, default_connections, drop_map
...
# TODO: Use correct entrance and exit names for multi entrance/exit locations - All dungeons go here
# i.e. Pyramid Hole -> Pyramid -> Pyramid Exit

# TODO: Make a separate app/window from main generator, - put worlds side by side

# TODO: Add exception for links house exit, must be added to exists and two-way
